      ...
      axios.get(`http://localhost:8081/data`)  
              .then(res => {  
                      ...
                      cga.forEach(record => {  
                              ...
                              gnw.push(record.ngoals);
                              grm.push(record.dgoals);
                              gup.push(record.ugoals)
                      });  
                      this.setState({  
                              Data: {  
                                      labels: iter,
    ...
    return (
      ...
      <div className="chart" style={{width: '400px'}}>
        <Bar
          ...
          options={{
            scales:{
              yAxes:[{stacked: true, scaleLabel: {display: true, labelString: 'Goals'}}],
              xAxes:[{stacked: true, }],
